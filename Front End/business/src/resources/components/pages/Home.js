...
import img4 from "../../../images/django.jpg";
                        ...
                        <div className="row gx-5 align-items-center justify-content-center">
                            <div className="col-lg-8 col-xl-7 col-xxl-6">
                                <div className="my-5 text-center text-xl-start">
                                    <h1 className="display-5 fw-bolder text-white mb-2">AI for modern businesses</h1>
                                    ...
                                    <div className="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                        ...
                                        <a className="btn btn-outline-light btn-lg px-4" rel="noreferrer" href="https://ai.googleblog.com/" target='_blank'>Learn More</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-5 col-xxl-6 d-none d-xl-block text-center"><img className="img-fluid rounded-3 my-5" src={img1} alt="..." /></div>
                        </div>
                    </div>
                </header>
                {/* <!-- Features section--> */}
